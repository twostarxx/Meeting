...
public class LineColumnDependencyActivity extends ActionBarActivity {
    private TextView textViewMeetName, textViewMeetIntroduction;
...
//        Log.i("XING","PreviewLineChartActivity, meetShow: " + meetShow.getMeetName().toString());
        textViewMeetName = (TextView) findViewById(R.id.meetNameLC);
    ...
    public static class PlaceholderFragment extends Fragment {
        public final static String[] months = new String[]{"Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7", "Q8", "Q9","Q10","Q11","Q12"};

        public final static String[] days = new String[]{"Ans1", "Ans2", "Ans3", "Ans4", "Ans5", "Ans6", "Ans7",};
        ...
        private void generateColumnData() {
            ...
            columnData.setAxisYLeft(new Axis().setHasLines(true).setMaxLabelChars(1));
